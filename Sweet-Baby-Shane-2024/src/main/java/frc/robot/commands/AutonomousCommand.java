...
public class AutonomousCommand extends SequentialCommandGroup {
    ...
    public AutonomousCommand(Shooter shooter, Intake intake, DriveSubsystem driveTrain, IntakePivot intakePivot) {
        addCommands(
            ...
            new ShooterCommand(shooter, () -> 1.0).withTimeout(2),
            ...
            new RunCommand(() -> {
                shooter.stop();
                intake.stop();
            }, shooter, intake, intakePivot).withTimeout(0.1),
            ...
            new RunCommand(() -> driveTrain.drive(0, 0, 0, false, true), driveTrain).withTimeout(0.1),
            ...
            new IntakePivotLimitCommand( intakePivot, IntakePivotLimitCommand.Behavior.STOW ).withTimeout(0),
